    ...
    <div className="relative grid grid-flow-row gap-4 mt-3 mb-3">
        ...
        <p>
          Hello there! I&apos;m Manoranjith Shankar, based out of Hosur, India. I&apos;m a Designer and a full Stack Developer with a passion for building secure applications. 
            I code, break things, fix them 🔁. Oh, Just in case if you need my <a href="https://drive.google.com/file/d/1jaX3A7BCnLN-3nxZ1pZZQdkPgcfC5iX7/view?usp=sharing" target='_blank' className="no-underline hover:underline underline-offset-4">📄resume</a>.
        </p>
    </div>
  )
}
